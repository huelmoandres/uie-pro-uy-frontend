        ...
        <View style={[styles.container, { backgroundColor: bg }]}>
            <View style={styles.content}>
                ...
                <View style={styles.dots}>
                    <Animated.View style={[styles.dot, d1Style, { backgroundColor: dotColor }]} />
                    <Animated.View style={[styles.dot, d2Style, { backgroundColor: dotColor }]} />
                    <Animated.View style={[styles.dot, d3Style, { backgroundColor: dotColor }]} />
                </View>
            </View>
        </View>
    );
