...
import { contactSupportSchema, type ContactSupportFormData } from '@schemas/support.schema';
                        ...
                        >
                            ...
                            <View className="mb-4">
                                ...
                                <Controller
                                    ...
                                    render={({ field: { onChange, onBlur, value } }) => (
                                        <View className={`flex-row items-center rounded-2xl border px-4 ${errors.name ? 'border-danger bg-danger/5' : 'border-slate-200 bg-slate-50 dark:border-white/10 dark:bg-white/5'}`}>
                                            <User size={16} color={errors.name ? '#EF4444' : '#94A3B8'} />
                                            <TextInput
                            ...
                            <View className="mb-4">
                                ...
                                <Controller
                                    ...
                                    name="email"
                                    render={({ field: { onChange, onBlur, value } }) => (
                                        <View className={`flex-row items-center rounded-2xl border px-4 ${errors.email ? 'border-danger bg-danger/5' : 'border-slate-200 bg-slate-50 dark:border-white/10 dark:bg-white/5'}`}>
                                            <Mail size={16} color={errors.email ? '#EF4444' : '#94A3B8'} />
                                            <TextInput
                                                className="flex-1 px-3 py-3 font-sans text-[14px] text-slate-900 dark:text-white"
                            ...
                            <View className="mb-7">
                                ...
                                <Controller
                                    ...
                                    name="message"
                                    render={({ field: { onChange, onBlur, value } }) => (
                                        <View className={`rounded-2xl border px-4 pt-3 pb-2 ${errors.message ? 'border-danger bg-danger/5' : 'border-slate-200 bg-slate-50 dark:border-white/10 dark:bg-white/5'}`}>
                                            <View className="flex-row gap-3">
                                                <AlignLeft size={16} color={errors.message ? '#EF4444' : '#94A3B8'} style={{ marginTop: 2 }} />
                                                <TextInput
