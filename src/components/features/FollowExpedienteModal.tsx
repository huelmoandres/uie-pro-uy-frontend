            ...
            <View className="mb-2">
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <View
                    className={`flex-row items-center rounded-2xl border px-4 ${errors.iue ? "border-danger bg-danger/5" : "border-slate-200 bg-slate-50 dark:border-white/10 dark:bg-white/5"}`}
                  >
                    <FileSearch
                      size={18}
                      color={errors.iue ? "#EF4444" : "#94A3B8"}
                    />
                    <TextInput
                      ref={inputRef}
