...
import { FileText, Bell, Calculator, Check, Star, FileDown, LayoutDashboard, CalendarClock, StickyNote } from 'lucide-react-native';
...
const BENEFITS: {
    ...
    },
    {
        ...
        description: 'Plazos procesales detectados automáticamente en tus decretos.',
    },
    {
        icon: Star,
        title: 'Favoritos',
        description: 'Marcá expedientes como favoritos para acceder rápido a los más importantes.',
    },
    {
        icon: FileDown,
    ...
    },
    {
        ...
        description: 'Plazos organizados por vencimiento y agendá turnos directamente.',
    },
    {
        icon: LayoutDashboard,
        title: 'Dashboard',
        description: 'Vista general con estadísticas, etapas procesales y actividad reciente.',
    },
    {
        icon: StickyNote,
