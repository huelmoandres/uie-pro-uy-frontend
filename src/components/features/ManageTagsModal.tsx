...
export const ManageTagsModal = React.memo(({ visible, onClose }: Props) => {
    ...
    }, [name, isCreating, editingId, selectedColor, createTag, updateTag, resetForm]);
    ...
    return (
        <>
            ...
            >
                <Animated.View entering={FadeIn.duration(200)} className="flex-1 bg-black/50 justify-end">
...
const InlineTagForm = ({
    ...
    <View className="gap-3 p-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/40">
        ...
        <View className="flex-row gap-2 justify-end">
            ...
            >
                <Text className="text-[12px] font-sans-semi text-slate-500">Cancelar</Text>
            </Pressable>
            <Pressable
                onPress={onSave}
