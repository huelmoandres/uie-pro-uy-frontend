...
import { Modal, Pressable, ScrollView, Text, View, ActivityIndicator, StyleSheet } from 'react-native';
 ...
 */
export const TagPickerModal = React.memo(({ visible, iue, assignedTagIds, onClose }: Props) => {
                ...
                <View className="bg-white dark:bg-slate-900 rounded-t-[28px] overflow-hidden shadow-2xl">
                            ...
                            tags.map((tag) => {
                                ...
                                return (
                                    <Pressable
                                        ...
                                        disabled={isPending}
                                        className={`flex-row items-center justify-between px-3 py-2.5 rounded-xl border active:opacity-70 ${isAssigned
                    ...
                    <View className="px-5 py-4 border-t border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-slate-800/20">
                        <Pressable
                            onPress={handleApply}
                            disabled={isPending}
                            className={`h-12 w-full flex-row items-center justify-center rounded-xl transition-all ${hasChanges
                        ...
                        >
                            {isPending ? (
                                ...
                                <Text
                                    className={`text-[15px] font-sans-bold ${hasChanges
