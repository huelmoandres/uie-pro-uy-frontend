    ...
    success: ({ text1, text2 }) => (
        <View className="mx-4 w-[92%] flex-row items-center rounded-2xl border border-success/20 bg-white dark:bg-primary p-4 shadow-premium dark:shadow-premium-dark">
            ...
            <View className="flex-1">
                <Text className="text-[13px] font-sans-bold text-slate-900 dark:text-white tracking-tight">{text1}</Text>
                {text2 && <Text className="text-[11px] font-sans text-slate-500 dark:text-slate-400 mt-0.5 leading-tight">{text2}</Text>}
            </View>
        </View>
    ),
    error: ({ text1, text2 }) => (
