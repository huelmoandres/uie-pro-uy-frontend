            ...
            <View style={styles.overlay}>
                ...
                <View className="w-[88%] max-w-[360px] overflow-hidden rounded-[32px] bg-white dark:bg-[#0B1120] border border-slate-100 dark:border-white/5 shadow-2xl">
                    <View className="p-8 items-center">
                        ...
                        <Text
                            className="text-center text-xl font-sans-bold text-slate-900 dark:text-white"
                        >
                            {title}
                        </Text>

                        <Text
                            className="mt-3 text-center text-[14px] leading-5 text-slate-500 dark:text-slate-400 px-1"
                        >
                            {description}
                        </Text>
                    </View>
